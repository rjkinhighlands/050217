## 7.1 Lesson Plan - Intro to Client-Side Storage
...
* Have your TAs reference [7.1-TimeTracker](7.1-TimeTracker.xlsx) to help keep track of time during class.
...
* Open up [`1-student-do-todolist-solution.html`](Activities/01-todolist-nopersistence/SOLVED/1-student-do-todolist-solution.html) in the browser and demonstrate the functionality of the intended to-do application. Point-out that the todo items are added consecutively and that clicking the "X" button closes the appropriate todo item.
...
* **Files**:
  ...
  * [`1-student-do-todolist`](Activities/01-todolist-nopersistence/1-student-do-todolist.html) (unsolved)
...
* **Instructions**:
  ...
  * Then create a Basic To-Do application using the [`1-student-do-todolist`](Activities/01-todolist-nopersistence/1-student-do-todolist.html) (unsolved) as a starting point. The HTML is already created for you so you will only have to fill in the javascript sections where there are large blanks. Alternatively, if you are feeling bold and capable, your group may code it from scratch without the use of the base code provided.
...
* Open the [`1-student-do-todolist-solution.html`](Activities/01-todolist-nopersistence/SOLVED/1-student-do-todolist-solution.html) and walk students through the code.
...
* Open [`2-student-do-signin-no-persistence-solution.html`](Activities/02-signin-nopersistence/SOLVED/2-student-do-signin-no-persistence-solution.html) in the browser and show students the sign-in page. For now the focus should be on creating a sign-in page that simply saves the user input and displays it inside of a text-box.

* Then slack out the following instructions and files.

* **Files:**

  * [`2-student-do-signin-no-persistence`](Activities/02-signin-nopersistence/2-student-do-signin-no-persistence.html) (unsolved)

* **Instructions:**

  * Using the [`2-student-do-signin-no-persistence`](Activities/02-signin-nopersistence/2-student-do-signin-no-persistence.html) as a starting point, fill in the JavaScript code necessary to make the page "save user inputs" and then re-display them on the second panel (most recent member).
...
* Open [`2-student-do-signin-no-persistence-solution.html`](Activities/02-signin-nopersistence/SOLVED/2-student-do-signin-no-persistence-solution.html) and walk students through understanding the code. Make sure they can re-explain the sections to you line by line!
...
* Open [`3-instructor-do-localstorage.html`](Activities/03-localstorage-demo/3-instructor-do-localstorage.html). Help walk your students through the key lines of code in the program. Point out that data is getting stored in a property associated with localStorage.
...
* Open [`4-student-do-signin-localstorage-solution.html`](Activities/04-signin-localstorage/4-student-do-signin-localstorage-solution.html) in your browser and show them how a re-configured version of the code would work if it utilized localStorage.

* Then slack out the following files and instructions:

* **Files:**

  * [`2-student-do-signin-no-persistence-solution.html`](Activities/02-signin-nopersistence/SOLVED/2-student-do-signin-no-persistence-solution.html) (If you haven't sent this already)

* **Instructions:**

  * Using the solution provided to you in [`2-student-do-signin-no-persistence-solution.html`](Activities/02-signin-nopersistence/SOLVED/2-student-do-signin-no-persistence-solution.html), re-configure the application so that it utilizes localStorage.
...
* Review the code provided in [`4-student-do-signin-localstorage-solution`](Activities/04-signin-localstorage/4-student-do-signin-localstorage-solution.html) -- paying particular attention to point out all the sections where localStorage is being cleared, set, or obtained (i.e. getItem). Also point out the arguments needed to set and get data.
...
* You can use [`5-student-do-signin-session-storage-solution.html`](Activities/05-signin-sessionstorage/5-student-do-signin-session-storage-solution.html) to quickly show the solution here.
...
* Then walk students through the code associated: [`6-instructor-do-cookies-intro.html`](Activities/06-cookies-demo/6-instructor-do-cookies-intro.html).
...
* Demonstrate to students a working version of the code in browser using [`8-student-do-todolist-localstorage-solution.html`](Activities/08-todolist-localstorage/8-student-do-todolist-localstorage-solution.html).
...
* **Files:**
  ...
  * [`1-student-do-todolist-solution.html`](Activities/01-todolist-nopersistence/SOLVED/1-student-do-todolist-solution.html) (If you haven't sent this already)

* **Instructions:**

  * Using a working example of the to-do application ([`1-student-do-todolist-solution.html`](Activities/01-todolist-nopersistence/SOLVED/1-student-do-todolist-solution.html)) incorporate the use of `localStorage` to create data persistence.
...
* Walk students through the coded solution. [`8-student-do-todolist-localstorage-solution.html`](Activities/08-todolist-localstorage/8-student-do-todolist-localstorage-solution.html) and use the code comments to help guide the discussion.
